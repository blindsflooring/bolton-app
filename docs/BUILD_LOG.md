...
- Build order for the rest of the Master Workflow proposal, smallest/lowest-risk first: booking visibility fix + Decline Quote reason → Order receiving state + Installation "In Progress" + Sign-off → PaymentRecord ledger.
